...
/// @title IStreamChannel
/// @notice Interface for the StreamChannel escrow contract — MPP-compatible on any EVM chain.
/// @dev Adapted from Tempo's ITempoStreamChannel for standard ERC-20 tokens.
